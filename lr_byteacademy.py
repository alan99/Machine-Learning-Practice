# -*- coding: utf-8 -*-
"""LR_ByteAcademy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/alan99/Machine-Learning-Practice/blob/master/LR_ByteAcademy.ipynb
"""
...
for fn in uploaded.keys():
  print('User uploaded file with {name} and length {length} bytes'.format(name=fn, length=len(uploaded[fn])))
